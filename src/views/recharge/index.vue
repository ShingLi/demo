<template>
    <transition name='slide' mode='out-in'>
        <div class="recharge-wrapper">
            <v-header title='充值' text='返回' @back='back'>
            ...
            <form @submit.prevent='submit'>
                <scroll class="scroll">
                    ...
                    <div class="account-money">
                        <tag icon='icon-xiaofei01' text='账户余额'></tag>
                        <p class="icons">
                            <i class="iconfont icon-zhanghu greenColor"></i>
                            <span>玉伯</span>
                                <i class="iconfont icon-tuiguangzhuanqian greenColor"></i>
                            <span>1000000元</span>
                        </p>
                    </div>
                    <!-- 充值金额 -->
...
<script>
    ...
    import { Cell, CellGroup, Radio, RadioGroup, Button } from 'vant'
    export default {
        name: 'recharge',
        data () {
            return {
